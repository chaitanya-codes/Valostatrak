...
module.exports.execute = async (client, message, args, send) => {
	...
	if (!findWeapon || !findWeapon?.displayName) findWeapon = weaponData.find(weapon => weapon.displayName.toLowerCase() === "melee")

	if (findWeapon && findWeapon?.displayName) {
		let findSkin = findWeapon.skins.find(skin => skin.displayName.toLowerCase().replace("//", " ") === skinName.toLowerCase().replace("//", " "))
